...
public class BoardView {
	...
	public Point2D gridToPane(ChessPiece piece, int x, int y) {
		...
		if (x < 0 || x > 7 || y < 0 || y > 7)
			throw new IllegalArgumentException("Piece out of grid: (" + x + ","
					+ y + ")");
	...
	// Convertit des coordonnées en pixels sur la fenêtre d'interface en
	// coordonnées dans la grille de l'échiquier
	// Utilisé pour détecter qu'on a touché une case spécifique de la
	// grille.
