...
public class GameView extends Application{
	...
	private void clearGame() {
		if (game.getBoard() != null) {
			gamePane.getChildren().remove(game.getBoard().getUI());
		}
	}
	...
	private void loadBoard(File file) {
		try {
			game.setBoard(ChessBoard.readFromFile(file, boardPosX, boardPosY));
		} catch (Exception e) {
